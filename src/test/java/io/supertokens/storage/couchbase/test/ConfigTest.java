...
//                "\"couchbase+srv://root:root@cluster0.zh79vjj.couchbase
...
//
//        Utils.setValueInConfig("couchbase_connection_uri",
//                "\"couchbase://root:root@ac-fwlbhn2-shard-00-00.zh79vjj.couchbase.net:27017,ac-fwlbhn2-shard-00-01"
//                        + ".zh79vjj.couchbase.net:27017,ac-fwlbhn2-shard-00-02.zh79vjj.couchbase"
...
//    }
    ...
    public void testThatCustomConfigLoadsCorrectly() throws Exception {
        ...
        Utils.setValueInConfig("couchbase_key_value_collection_name", "\"temp_name\"");
    ...
    public void testBadPortInput() throws Exception {
        ...
        Utils.setValueInConfig("couchbase_connection_uri", "couchbase://root:root@localhost:27018");
        ...
        assertEquals(e.exception.getCause().getMessage(),
                "Error connecting to MongoDB instance. Please make sure that MongoDB is running and that you have "
                        + "specified the correct value for 'couchbase_connection_uri' in your config file");
    ...
    public void testBadHostInput() throws Exception {
        ...
        Utils.setValueInConfig("couchbase_connection_uri", "couchbase://root:root@random:27017");
        ...
        assertEquals(
                "Timed out after 5000 ms while waiting to connect. Client view of cluster state is {type=UNKNOWN, "
                        + "servers=[{address=random:27017, type=UNKNOWN, state=CONNECTING, exception={com.couchbase"
    ...
    public void testThatChangeInCollectionNameIsCorrect() throws Exception {
        ...
        Utils.setValueInConfig("couchbase_key_value_collection_name", "key_value_collection");
        Utils.setValueInConfig("couchbase_session_info_collection_name", "session_info_collection");
    ...
    public void testAddingTableNamePrefixWorks() throws Exception {
        ...
        Utils.setValueInConfig("couchbase_key_value_collection_name", "key_value_table");
        Utils.setValueInConfig("couchbase_collection_names_prefix", "some_prefix");
    ...
    public void testValidConnectionURI() throws Exception {
        {
            ...
            Utils.setValueInConfig("couchbase_connection_uri", "couchbase://root:root@localhost:27017/supertokens");
            Utils.commentConfigValue("couchbase_database_name");
...

        {
            ...
            Utils.setValueInConfig("couchbase_connection_uri", "couchbase://root:root@localhost/supertokens");
            Utils.commentConfigValue("couchbase_database_name");
...

        {
            ...
            Utils.setValueInConfig("couchbase_connection_uri", "couchbase://localhost:27017/supertokens");
            Utils.commentConfigValue("couchbase_database_name");
...

        {
            ...
            Utils.setValueInConfig("couchbase_connection_uri", "couchbase://root:root@localhost:27017");
            Utils.commentConfigValue("couchbase_database_name");
    ...
    public void testInvalidConnectionURI() throws Exception {
        {
            ...
            Utils.setValueInConfig("couchbase_connection_uri", ":/localhost:27017/supertokens");
