...
public class CouchbaseLoggingAppender implements Appender<ILoggingEvent> {

    static final String NAME = "io.supertokens.storage.couchbase.CouchbaseLoggingAppender";

    private final Start start;

    private Context context;

    CouchbaseLoggingAppender(Start start) {
        super();
        this.start = start;
    }
